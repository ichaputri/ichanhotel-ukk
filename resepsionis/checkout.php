        ...
        <div class="content">
            <div class="content-header">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0" style="font-family:'Old Standard TT', serif;"> IchanHotel | Checkout </h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div>
                <br><br>
                    ...
                    <div class="col-md-12">
                        <div class="card" style="background-color:#DEDEDA; vertical-align:middle;">
                            <div class="card-body">
                                ...
                                <center>
                                    <img src="../assets/images/logo.png" alt="ichanhotel" style="opacity: .8; ">
                                </center>
                                <br /><br>
                                <?php
                                include '../koneksi.php';
                            ...
                            <button type="submit" class="btn btn-default" name="tambahkamarcheckout"
                            style="background-color:#bfa145; color:black;">Checkout</button>
                            </div>
                        </div>
                        </form>
                            <?php } ?>
