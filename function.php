...
if(isset($_POST['kamardipesan'])){
    ...
    if (!$stocksekarang >= $jml_kamar) {
        ...
        $addtotambahkamar = mysqli_query($koneksi,"INSERT INTO pesanan ('','cek_in','cek_out','jml_kamar','','nama_pemesan','email_pemesan','hp_pemesan','nama_tamu','id_kamar','1','koderes') VALUES ('','$cek_in','$cek_out','$jml_kamar','','$nama_pemesan','$email_pemesan','$hp_pemesan','$nama_tamu','$id_kamar','1','$koderes')");
