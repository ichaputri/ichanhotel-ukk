                        ...
                        <div class="card" style="background-color:#DEDEDA; vertical-align:middle;">
                            <div class="card-body">
                                ...
                                <div id="print-area-3" class="print-area">
                                    ...
                                    <p>KodeRes : <?php echo $data['koderes']; ?></p>
                                    <p>Tipe Kamar :
                                        <?php 
                                    ...
                                    <div class="row">
                                        ...
                                        ?>
                                               ...
                                               while ($a = mysqli_fetch_array($kamar)) {
                                                   if ($a['id_kamar'] == $data['id_kamar']) { ?>
                                                            Rp. <?php echo $a['harga']*$data['jml_kamar'];?>
                                                            <?php
                                                }
                                               }
                                        ?>
                                    ...
                                    <div
                                        style="background-color:#DAA520; border: 3px #DAA520 double; padding: 10px; text- align: left;">
